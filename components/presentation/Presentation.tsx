...
const slidesData = [
  ...
  },
  {
    ...
    html: `
      <div style="display:flex;gap:28px;">
        <div style="flex:1;">
          <h2 style="font-family:Playfair Display, serif;font-size:28px;">Financial Impact: 66.4% Cost Reduction & 108.7% Profit Increase</h2>
          <div style="margin-top:12px;background:#F5F7F6;padding:12px;border-left:4px solid #1A442D;">
            <p style="margin:0;">Listedit delivers transformative financial results through both cost reduction and revenue enhancement, creating a compelling ROI for real estate agencies.</p>
          </div>
          <div style="margin-top:20px;">
            <table style="width:100%;border-collapse:collapse;">
              <thead>
                <tr style="background:#F5F7F6;">
                  <th style="text-align:left;padding:8px;border-bottom:2px solid #1A442D;">Category</th>
                  <th style="text-align:left;padding:8px;border-bottom:2px solid #1A442D;">Before</th>
                  <th style="text-align:left;padding:8px;border-bottom:2px solid #1A442D;">After</th>
                  <th style="text-align:left;padding:8px;border-bottom:2px solid #1A442D;">Change</th>
                </tr>
              </thead>
              <tbody>
                <tr>
                  <td style="padding:8px;">Revenue</td>
                  <td style="padding:8px;">A$33,280,000</td>
                  <td style="padding:8px;">A$40,928,000</td>
                  <td style="padding:8px;color:#1A442D;">+23.0%</td>
                </tr>
                <tr>
                  <td style="padding:8px;">Software & Services</td>
                  <td style="padding:8px;">A$3,328,000</td>
                  <td style="padding:8px;">A$2,664,000</td>
                  <td style="padding:8px;color:#D04848;">-20.0%</td>
                </tr>
                <tr>
                  <td style="padding:8px;">Repetitive Tasks</td>
                  <td style="padding:8px;">A$9,360,000</td>
                  <td style="padding:8px;">A$2,808,000</td>
                  <td style="padding:8px;color:#D04848;">-70.0%</td>
                </tr>
                <tr>
                  <td style="padding:8px;">Human Costs</td>
                  <td style="padding:8px;">A$3,600,000</td>
                  <td style="padding:8px;">A$0</td>
                  <td style="padding:8px;color:#D04848;">-100.0%</td>
                </tr>
                <tr>
                  <td style="padding:8px;">Total Costs</td>
                  <td style="padding:8px;">A$16,288,000</td>
                  <td style="padding:8px;">A$5,472,000</td>
                  <td style="padding:8px;color:#D04848;">-66.4%</td>
                </tr>
                <tr>
                  <td style="padding:8px;">Profit</td>
                  <td style="padding:8px;">A$16,992,000</td>
                  <td style="padding:8px;">A$35,456,000</td>
                  <td style="padding:8px;color:#1A442D;">+108.7%</td>
                </tr>
              </tbody>
            </table>
            <div style="margin-top:12px;background:#F5F7F6;padding:16px;border-radius:6px;">
              <div style="font-weight:700;">A$18,464,000</div>
              <div>Total Annual Benefit (Combined Revenue Increase & Cost Savings)</div>
            </div>
          </div>
        </div>
        <div style="flex:1;">
          <img src="https://private-us-east-1.manuscdn.com/sessionFile/tIa20FjOkPFzgtVnBlASuP/sandbox/slides_resource_in7yykvs484wxki28mczy-6d9282e2-e2b-prod-aws_1754805226090_na1fn_L2hvbWUvdWJ1bnR1L2ZpbmFuY2lhbF9jaGFydA.png" alt="Financial Impact Chart" style="max-width:100%;border-radius:6px;box-shadow:0 6px 18px rgba(0,0,0,0.06);" />
        </div>
      </div>
    `,
    kind: 'financial',
    chart: {
      labels: ['Revenue', 'Software & Services', 'Repetitive Tasks', 'Human Costs', 'Total Costs', 'Profit'],
      datasets: [
        { label: 'Before (A$ millions)', data: [33.28, 3.328, 9.36, 3.6, 16.288, 16.992], backgroundColor: '#0D1C17' },
        { label: 'After (A$ millions)', data: [40.928, 2.664, 2.808, 0, 5.472, 35.456], backgroundColor: '#1A442D' },
      ],
      height: 360,
    },
  },
  {
    ...
    html: `
      <div>
        <h2 style="font-family:Playfair Display,serif;font-size:28px;">Cost Breakdown: A$10.8M Annual Savings</h2>
        <div style="background:#F5F7F6;padding:12px;border-left:4px solid #1A442D;margin-top:8px;">
          <p style="margin:0;">Listedit eliminates redundant costs across multiple categories, delivering substantial savings while improving operational efficiency.</p>
        </div>
        <div style="display:flex;gap:18px;margin-top:18px;">
          <div style="flex:1;">
            <div style="background:#F5F7F6;padding:12px;border-radius:6px;margin-bottom:8px;">
              <div style="font-weight:700;">A$664K</div>
              <div>Software & Services (20%)</div>
            </div>
            <div style="background:#F5F7F6;padding:12px;border-radius:6px;margin-bottom:8px;">
              <div style="font-weight:700;">A$6.55M</div>
              <div>Repetitive Tasks (70%)</div>
            </div>
            <div style="background:#F5F7F6;padding:12px;border-radius:6px;">
              <div style="font-weight:700;">A$3.6M</div>
              <div>Human Costs (100%)</div>
            </div>
            <div style="margin-top:12px;font-weight:700;">Total Annual Cost Reduction: A$10,816,000 (66.4%)</div>
          </div>
          <div style="flex:1;">
            <div style="height:300px;">
    ...
    kind: 'charts',
    chart: {
      labels: ['Software & Services', 'Repetitive Tasks', 'Human Costs', 'Total Costs'],
      datasets: [
        { label: 'Before (A$ millions)', data: [3.33, 9.36, 3.6, 16.29], backgroundColor: '#0D1C17' },
        { label: 'With Listedit (A$ millions)', data: [2.66, 2.81, 0, 5.47], backgroundColor: '#1A442D' },
      ],
      height: 300,
    },
  },
